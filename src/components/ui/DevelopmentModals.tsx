import { LogIn, WalletCards, X } from "lucide-react"

export function DevelopmentModals() {
  return (
    <>
      <section
        id="portal-aluno-em-desenvolvimento"
      ...
      >
        ...
        <div className="relative z-[2001] w-full max-w-md rounded-[2rem] bg-white p-6 text-center shadow-2xl">
          ...
          <p className="mt-4 leading-7 text-slate-700">
            Em breve, pais, alunos, professores e direção poderão acessar
            informações acadêmicas, frequência, notas, comunicados e dados
            escolares em um ambiente próprio.
          </p>
